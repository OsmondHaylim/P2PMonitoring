                ...
                <?php foreach ($kc as $key => $row) : ?>
                    <a href="/rm/<?= $row->nama_pn; ?>">
                        <div class="rows content">
                            ...
                            <div class = "stdptp">
                                <p><?= number_format($row->persenptp, 2, '.', ''); ?></p>
                            </div>
                            <div class = "stdptp">
                                <p><?= number_format($row->persennonptp, 2, '.', ''); ?></p>
                            </div>
                            <div class = "right stdptp">
                                <p><?= number_format($row->osptp, 0, ",","."); ?></p>
                            </div>
                            <div class = "right stdptp">
                                <p><?= number_format($row->osnonptp, 0, ",","."); ?></p>
                            </div>
                        </div>
                    </a>
                <?php endforeach;?>
